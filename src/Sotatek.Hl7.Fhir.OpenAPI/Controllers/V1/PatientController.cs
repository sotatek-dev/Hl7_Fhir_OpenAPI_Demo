...
using Sotatek.Hl7.Fhir.Common.Core.Attributes;
using Sotatek.Hl7.Fhir.Common.Core.Errors;
using Hl7.Fhir.Model;
using Sotatek.Hl7.Fhir.OpenAPI.Controllers.Base;
...
namespace Sotatek.Hl7.Fhir.OpenAPI.Controllers.V1
{
    /// <summary>
